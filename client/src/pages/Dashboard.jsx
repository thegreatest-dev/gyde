...
import { Plus, Flame, CheckCircle, Sun, Moon, Menu, X, Home, TrendingUp, Target, Settings, User, Eye, EyeOff, Headset } from 'lucide-react';
      ...
      {showGoalModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className={`relative w-full max-w-md rounded-3xl p-6 pb-24 ${
            ...
            {goalError && (
              <div className="mb-4 text-red-500 text-sm font-medium text-center">{goalError}</div>
            )}
