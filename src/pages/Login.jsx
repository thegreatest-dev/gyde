  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-800 via-slate-700 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-t-3xl shadow-2xl overflow-hidden">
        {/* Header with logo */}
        <div className="bg-gradient-to-b from-slate-800 to-slate-900 px-8 py-16 text-center">
          <div className="mb-8">
            <div className="inline-flex items-center justify-center">
              <div className="flex items-center space-x-1">
                ...
                <div className="w-8 h-8 bg-teal-400 rounded-full flex items-center justify-center -ml-2">
                  <span className="text-white font-bold text-lg">G</span>
                </div>
              </div>
              <span className="text-white text-3xl font-light ml-2">Gyde</span>
            </div>
          </div>
        </div>
        ...
        <div className="px-8 py-8">
          ...
          <div className="mt-8 text-center">
            ...
            <button className="text-slate-600 hover:text-slate-800 font-medium text-sm transition-colors">
              Sign Up
            </button>
          </div>
        </div>
